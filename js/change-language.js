...
function changeToGreek() {
    ...
    //faqs
    document.getElementsByClassName('col-md-12 text-center wow zoomIn')[0].getElementsByTagName('h2')[0].getElementsByTagName('b')[0].innerHTML = 'Γενικές Ερωτήσεις';
